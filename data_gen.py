...
from utils_1 import load_wav_to_torch, load_filepaths_and_text, text_to_sequence, load_audiopaths_and_text_json
...
if __name__ == '__main__':
    import config
    from utils_1 import parse_args, sequence_to_text
